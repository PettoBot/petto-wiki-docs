...
```javascript Example
/level reward add level:10 role:@Regular
/level reward add level:25 role:@Veteran
```
...
```javascript Example
/level multiplier set value:2 role:@Booster
/level multiplier set value:0.5 channel:#off-topic
```
