...
```javascript Example
/boosterrole color hex:#ff91c2
/boosterrole color hex:#ff91c2 hex2:#8399ff
/boosterrole icon input=🎀
```
...
```javascript Example
/boosterrole admin set user:@Someone hex:#ff91c2 name=Someone's Role
/boosterrole admin link user:@Someone role:@ExistingRole
```
...
```javascript Example
/boosterrole admin base role:@Booster
/boosterrole admin limit count:1
/boosterrole admin cooldown type:color duration:24h
```
