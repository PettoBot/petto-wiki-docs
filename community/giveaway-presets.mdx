...
```javascript Example
/giveawaypreset create name:boosters
/giveawaypreset add-role name:boosters role:@Booster entries:3 claim_time:10m entries_stack:true
```

```javascript Prefix
!giveawaypreset add-role boosters @Booster 3
```
...
Use a preset when starting a giveaway with `/giveaway start preset:<name>`.
