...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="glow" cx="50%" cy="35%" r="75%">
      <stop offset="0%" stop-color="#8399ff" stop-opacity="0.22"/>
      <stop offset="100%" stop-color="#8399ff" stop-opacity="0"/>
    </radialGradient>
  </defs>
  <rect width="1200" height="630" fill="#1e1d1b"/>
  <rect width="1200" height="630" fill="url(#glow)"/>
  <circle cx="1080" cy="90" r="3" fill="#8399ff" opacity="0.6"/>
  <circle cx="140" cy="540" r="3" fill="#8399ff" opacity="0.5"/>
  <circle cx="1000" cy="520" r="2" fill="#8399ff" opacity="0.4"/>
  <rect x="90" y="90" width="120" height="120" rx="28" fill="#262523" stroke="#8399ff" stroke-opacity="0.35" stroke-width="1.5"/>
  ...
  <rect x="90" y="520" width="46" height="6" rx="3" fill="#8399ff"/>
  <text x="150" y="527" font-family="Arial, sans-serif" font-size="22" font-weight="600" fill="#8399ff">petto.sbs</text>
</svg>
`;
